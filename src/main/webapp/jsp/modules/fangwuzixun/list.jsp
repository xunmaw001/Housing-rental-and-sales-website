		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">房屋资讯管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>房屋资讯管理</span></li>
								<li class="breadcrumb-item active"><span>房屋资讯列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">房屋资讯列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>封面图片</th>
											<th onclick="sort('zixunneirong')">资讯内容<i id="zixunneirongIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zixunneirongCell  = document.createElement('td');
						  ...
						  //如果图文详情包含图片
			  if(item.zixunneirong && item.zixunneirong.indexOf('img') != -1){
				//暂时只考虑图片+文字 和 文字+图片的情况
				var beginIndex = item.zixunneirong.indexOf('<img');
				var endIndex = item.zixunneirong.indexOf('>');				
				zixunneirongCell.innerHTML = item.zixunneirong.substring(beginIndex, endIndex+1).replace("img","img width='100' height='100'");				
			  }else{
			  	 if(item.zixunneirong != null && item.zixunneirong != "" && item.zixunneirong.length >= 11){
			  		zixunneirongCell.innerHTML = item.zixunneirong.substring(0, 10) + "..."; 
			  	}else{
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("fangwuzixun/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"fangwuzixun");
