...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>租赁订单管理</span></li>
								<li class="breadcrumb-item active"><span>编辑租赁订单</span></li>
							</ol>
						</div>
					</div>
				</div>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>租赁时间时间</label>
										<div id="zulinshijianshijianDate" class="input-append date form_datetime">
											<input id="zulinshijianshijian-input" name="zulinshijianshijian" size="15" type="text" readonly>
	...
	<script>
		...
		function dateTimePick(){
			...
			$("#zulinshijianshijianDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function dataBind(){
			...
			$("#zulinshijianshijian-input").val(ruleForm.zulinshijianshijian);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.zulinshijianshijian != null && res.data.zulinshijianshijian != ''){

					$("#zulinshijianshijian-input").val(res.data.zulinshijianshijian);
					$('#zulinshijianshijianFileName').val(res.data.zulinshijianshijian)
					}
