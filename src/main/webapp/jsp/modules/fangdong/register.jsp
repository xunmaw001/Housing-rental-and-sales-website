	...
	<div class="container">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">房东号</label> 
							<input type="text" name="fangdonghao" placeholder="房东号" class="form-control-i">
							</div>
																								<div class="form-group">
							...
							<input type="text" name="mima" placeholder="密码" class="form-control-i">
																								...
																								<div class="form-group">
							<label class="label">房东姓名</label> 
							<input type="text" name="fangdongxingming" placeholder="房东姓名" class="form-control-i">
							</div>
																								<div class="form-group">
							<label class="label">房东手机</label> 
							<input type="text" name="fangdongshouji" placeholder="房东手机" class="form-control-i">
							</div>
																																			<div class="form-group">
