        ...
        <div class="wrap-login100">
          ...
          <form class="login100-form validate-form layui-form">
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="zixunbiaoti" name="zixunbiaoti" placeholder="请输入资讯标题" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
            ...
            <div class="wrap-input100 validate-input">
              <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 0;">
                  <input class="input100" type="text" id="wenzhanglaiyuan" name="wenzhanglaiyuan" placeholder="请输入文章来源" autocomplete="off" class="layui-input" lay-ignore>
                </div>
              </div>
              <span class="focus-input100"></span>
              <span class="symbol-input100">
