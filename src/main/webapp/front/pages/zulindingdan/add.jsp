				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.beizhu" type="text" name="beizhu" id="beizhu" autocomplete="off" class="layui-input">
                                                                                ...
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">租赁时间时间：</label>
						<div class="layui-input-block">
							<input type="text" name="zulinshijianshijian" id="zulinshijianshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
