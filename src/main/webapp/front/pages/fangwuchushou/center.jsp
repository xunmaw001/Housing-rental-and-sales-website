				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="louceng" id="louceng" placeholder="楼层" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">楼号</label>
							<div class="layui-input-block">
								<input type="text" name="louhao" id="louhao" placeholder="楼号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">房屋设施</label>
							<div class="layui-input-block">
								<input type="text" name="fangwusheshi" id="fangwusheshi" placeholder="房屋设施" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">出售价格</label>
							<div class="layui-input-block">
								<input type="text" name="chushoujiage" id="chushoujiage" placeholder="出售价格" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">房东号</label>
							<div class="layui-input-block">
								<input type="text" name="fangdonghao" id="fangdonghao" placeholder="房东号" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="fangdongshouji" id="fangdongshouji" placeholder="房东手机" autocomplete="off" class="layui-input">
							</div>
						</div>
