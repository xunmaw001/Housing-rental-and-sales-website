				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('fangwuxinxi','房屋出租')" @click="onAcrossTap('fangwuchuzu')" type="button" class="layui-btn">
								房屋出租
							</button>
																					<button v-if="isAuth('fangwuxinxi','房屋出售')" @click="onAcrossTap('fangwuchushou')" type="button" class="layui-btn">
								房屋出售
							</button>
