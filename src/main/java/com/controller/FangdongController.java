...
public class FangdongController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FangdongEntity user = fangdongService.selectOne(new EntityWrapper<FangdongEntity>().eq("fangdonghao", username));
    ...
    public R register(@RequestBody FangdongEntity fangdong){
    	...
    	FangdongEntity user = fangdongService.selectOne(new EntityWrapper<FangdongEntity>().eq("fangdonghao", fangdong.getFangdonghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FangdongEntity fangdong, HttpServletRequest request){
